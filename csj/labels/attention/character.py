...
def read_sdb(label_paths, run_root_path, is_test=None,
    ...
    kanji_map_file_path = join(run_root_path, 'labels/attention/kanji2num.txt')
    kana_map_file_path = join(run_root_path, 'labels/attention/kana2num.txt')
    phone_map_file_path = join(run_root_path, 'labels/attention/phone2num.txt')
    if save_map_file:
        # kanji
